...
def resnet50_trained_on_SIN():
    model = load_model("resnet50_trained_on_SIN").module
    model.fc = nn.Identity()
    return model

def resnet50_trained_on_SIN_and_IN():
    model = load_model("resnet50_trained_on_SIN_and_IN").module
    model.fc = nn.Identity()
    return model

def resnet50_trained_on_SIN_and_IN_then_finetuned_on_IN():
    model = load_model("resnet50_trained_on_SIN_and_IN_then_finetuned_on_IN").module
    model.fc = nn.Identity()
    return model
