...
class cait_models(nn.Module):
    ...
    def forward_features(self, x, t_x):
        B = x.shape[0]
...
#         )
        checkpoint = torch.load("/home/code-base/user_space/cumix/checkpoints/XXS24_224.pth", map_location="cpu")
...
#             map_location="cpu", check_hash=True
#         )
        checkpoint = torch.load("/home/code-base/user_space/cumix/checkpoints/XXS24_384.pth", map_location="cpu")
        checkpoint_no_module = {}
        for k in model.state_dict().keys():
            checkpoint_no_module[k] = checkpoint["model"]['module.'+k]
